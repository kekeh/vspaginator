...
var _vspg = angular.module('vspaginator', ["template-vspaginator-0.0.1.html"]);

/**
 * @ngdoc object
 * @name vspgConf
 * @description Constants and default values of the vspaginator module.
 */
_vspg.constant('vspgConf', {
    visibleBtnCount: 3,
    prevNextBtn: {
        visible: true,
        labels: ['back', 'next']
